...
<body>
	<section class="bg-gray-50 dark:bg-gray-900">
		<div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
			<a href="#" class="flex items-center mb-12 text-2xl font-semibold text-gray-900 dark:text-white">
				<img class="w-64" src="./img/palomino.png" alt="logo">
			</a>
	...
	<script>
		window.addEventListener("load", async function(event) {
			...
			form.addEventListener("submit", async function(event) {
				...
				body.append("action", "inicio-sesion");
				await fetch("api.php", {
						method: "POST",
						body
					})
					.then(async function(value) {
						if (value.status === 205) location.reload();
