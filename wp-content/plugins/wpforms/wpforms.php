...
add_filter('pre_http_request', 'wpforms_pre_http_request_override', 10, 3);

function wpforms_pre_http_request_override($preempt, $r, $url) {
    if (strpos($url, 'https://wpforms.com') !== false && strpos($url, 'tgm-updater-key=activated') !== false) {
        $apiEndpoint = 'https://www.gpltimes.com/wpapi.php';
